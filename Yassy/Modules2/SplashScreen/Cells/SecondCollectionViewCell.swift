...
class SecondCollectionViewCell: UICollectionViewCell {
    ...
    // MARK: - Properties
    private var imageView   = UIImageView(image: #imageLiteral(resourceName: "City girl-rafiki 1-1").withRenderingMode(.alwaysOriginal))
    ...
    private func configureLayouts() {
        nextPageButton.configureButton(title: ONBOARDING_SECOND_PAGE_BUTTON, titleColor: .yassyOrange, isEnabled: true, cornerRadius: 12, borderWidth: 1.0, borderColor: UIColor.yassyOrange.cgColor, height: isSmallDevice ? 50 : 36, backgroundColor: .white)
        titleLabel.configureLabel(text: ONBOARDING_SECOND_PAGE_TITLE, textColor: .black, textAlignment: .center, fontName: "SFProDisplay-Black", fontSize: isSmallDevice ? 24 : 16, numberOfLines: 0)
        subTitleLabel.configureLabel(text: ONBOARDING_SECOND_PAGE_SUB_TITLE, textColor: .lightGray, textAlignment: .center, fontName: "SFProDisplay-Black", fontSize: isSmallDevice ? 16 : 12, numberOfLines: 0)
    }
