...
class HomeFavouriteCell: BaseSecondTableViewCell {
    override class func description() -> String {
        return "HomeFavouriteCell"
    }
    ...
    fileprivate func configureViews(){
        ...
        infoImageView.image = UIImage(named: "ic_home")?.withRenderingMode(.alwaysOriginal)
        titleLabel.textAlignment = .left
        
        titleLabel.font = .systemFont(ofSize: 16)
        titleLabel.text = HOME_BUTTON_TEXT
