...
class WorkFavouriteCell: BaseSecondTableViewCell {
    override class func description() -> String {
        return "WorkFavouriteCell"
    }
    ...
    fileprivate func configureViews(){
        ...
        infoImageView.image = UIImage(named: "ic_work")?.withRenderingMode(.alwaysOriginal)
        titleLabel.textAlignment = .left
        titleLabel.font = .systemFont(ofSize: 16)
        titleLabel.text = JOBE_BUTTON_TEXT
